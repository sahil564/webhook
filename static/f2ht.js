...
var graphData1 = {
    ...
    data: {
        ...
        datasets: [{
            label: 'upper value',
            data: [36,33,33,34,35,35,36,36,37,33,34,34,33,34,35,36,37,35,34,34,33,34,34,35],
            options: {
        ...
        },
        {
            ...
            data: [20,22,21,21,22,23,24,24,27,20,21,20,21,20,21,21,20,23,21,20,21,20,21,21],
            options: {
        ...
        {
            label: 'lower value',
            data: [16,16,13,14,15,16,17,18,19,10,11,12,12,18,18,18,19,10,11,16,18,12,14,15],
            options: {
...
var graphData2 = {
    ...
    data: {
        ...
        datasets: [{
            label: 'upper value',
            data: [2300,2306,2342,2330,2335,2376,2437,2318,2319,2301,2311,2312,2313,2314,2325,2326,2327,2338,2339,2331,2312,2333,2334,2335],
            options: {
        ...
        {
            label: 'predicted value',
            data: [2298,2300,2300,2295,2298,2299,2370,2300,2300,2297,2291,2303,2307,2309,2311,2301,2300,2305,2298,2300,2300,2295,2298,2299],
            options: {
        ...
        {
            label: 'lower value',
            data: [2280,2290,2300,2300,2300,2300,2290,2290,2290,2290,2279,2290,2294,2284,2285,2300,2300,2300,2300,2300,2298,2306,2304,2305],
            options: {
...
var graphData3 = {
    ...
    data: {
        ...
        datasets: [{
            label: 'upper value',
            data: [236,236,233,234,235,236,237,238,239,230,231,232,233,234,235,236,237,238,239,231,232,233,234,235],
            options: {
        ...
        {
            label: 'predicted value',
            data: [220,222,221,221,222,223,224,224,227,220,221,220,221,220,221,221,220,223,221,220,212,220,221,221],
            options: {
        ...
        {
            label: 'lower value',
            data: [206,200,203,204,205,206,207,208,209,200,201,202,203,204,205,206,207,208,209,201,202,203,204,205],
            options: {
